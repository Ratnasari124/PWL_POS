...
class UserController extends Controller
{
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            //Jika terjadi error ketika menghapus data, rediret kembai ke halaman dengan membawa pesan error
            return redirect('/user')->with('error', 'Data user gagal dihapus karena masih terdapat di tabel lain yang terkait data ini');
        }
    }
}
